...
class Lookup {
	...
	public static function countries () {
	  ...
	  $_['USAT'] = array('name'=>__('US Territories','Shopp'),'currency'=>array('code'=>'USD','format'=>'$#,###.##'),'units'=>'imperial','region'=>0);
		...
		$_['RO'] = array('name'=>__('Romania','Shopp'),'currency'=>array('code'=>'RON','format'=>'#.###,## lei'),'units'=>'metric','region'=>3);
		...
		$_['TR'] = array('name'=>__('Turkey','Shopp'),'currency'=>array('code'=>'TRY','format'=>'#.###,## TL'),'units'=>'metric','region'=>6);
		...
		$_['UY'] = array('name'=>__('Uruguay','Shopp'),'currency'=>array('code'=>'UYU','format'=>'$#,###.##'),'units'=>'metric','region'=>2);
		...
		$_['VE'] = array('name'=>__('Venezuela','Shopp'),'currency'=>array('code'=>'VEF','format'=>'Bs. #,###.##'),'units'=>'metric','region'=>2);
