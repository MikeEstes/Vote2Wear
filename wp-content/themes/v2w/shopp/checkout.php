	...
	<?php if ( shopp( 'cart.hasitems' ) ) : ?>
		...
		<ul>
			<?php if ( shopp( 'customer.notloggedin' ) ) : ?>
				<li>
					<label for="login" class="bigger"><?php _e('Login to Your Account','Shopp'); ?></label>
					<span><label for="account-login"><?php _e('Email','Shopp'); ?></label><?php shopp('customer','account-login','size=30&title='.__('Login','Shopp')); ?></span>
					<span><label for="password-login"><?php _e('Password','Shopp'); ?></label><?php shopp('customer','password-login','size=30&title='.__('Password','Shopp')); ?></span>
					<span><?php shopp('customer','login-button','context=checkout&value=Login'); ?></span>
				</li>
			<?php endif; ?>

			<li>
				<label for="firstname" class="bigger"><?php _e('Contact Information','Shopp'); ?></label>
				<span><label for="firstname"><?php _e('First','Shopp'); ?></label><?php shopp('checkout','firstname','required=true&minlength=2&size=30&title='.__('First Name','Shopp')); ?></span>
				<span><label for="lastname"><?php _e('Last','Shopp'); ?></label><?php shopp('checkout','lastname','required=true&minlength=2&size=30&title='.__('Last Name','Shopp')); ?></span>
				<span><label for="company"><?php _e('Company/Organization','Shopp'); ?></label><?php shopp('checkout','company','size=30&title='.__('Company/Organization','Shopp')); ?></span>
			</li>
			<li>
				<span><label for="phone"><?php _e('Phone','Shopp'); ?></label><?php shopp('checkout','phone','format=phone&size=30&title='.__('Phone','Shopp')); ?></span>
			...
			<?php if ( shopp( 'customer.notloggedin' ) ) : ?>
				<li>
					...
					<?php shopp('checkout','password','required=true&format=passwords&size=30&title='.__('Password','Shopp')); ?></span>

					<span><label for="confirm-password"><?php _e('Confirm Password','Shopp'); ?></label>
					<?php shopp('checkout','confirm-password','required=true&format=passwords&size=30&title='.__('Password Confirmation','Shopp')); ?></span>
				</li>
			<?php endif; ?>
			...
			<?php endif; ?>
					...
					<label for="billing-address" class="bigger"><?php _e( 'Billing Address', 'Shopp' ); ?></label>
					<div>
					...
					<div class="right">
						...
						<div class="select-wrap"><?php shopp( 'checkout.billing-state', 'required=auto&title=' . __( 'State/Province/Region billing address', 'Shopp' ) ); ?></div>
					</div>
					<div class="left">
					...
					<div class="right">
						...
						<div class="select-wrap"><?php shopp( 'checkout.billing-country', 'required=true&title=' . __( 'Country billing address', 'Shopp' ) ); ?></div>
					</div>
			<?php if ( shopp( 'cart.needs-shipped' ) ) : ?>
					<div class="inline">
				...
				<li class="half right" id="shipping-address-fields">
					<label for="shipping-address" class="bigger"><?php _e( 'Shipping Address', 'Shopp' ); ?></label>
					<div>
					...
					<div class="right">
						...
						<div class="select-wrap"><?php shopp( 'checkout.shipping-state', 'required=auto&title=' . __( 'State/Provice/Region shipping address', 'Shopp' ) ); ?></div>
					</div>
					<div class="left">
					...
					<div class="right">
						...
						<div class="select-wrap"><?php shopp( 'checkout.shipping-country', 'required=true&title=' . __( 'Country shipping address', 'Shopp' ) ); ?></div>
					</div>
				</li>
			<?php else: ?>
				</li>
			...
			<?php if ( shopp( 'checkout.card-required' ) ) : ?>
				<li class="payment">
					<label for="billing-card" class="bigger"><?php _e( 'Payment Information', 'Shopp' ); ?></label>
					<span>
				...
				<li class="payment">
					<span>
						...
						<div class="select-wrap"><?php shopp( 'checkout.billing-cardexpires-mm', 'required=true&minlength=2&maxlength=2&title=' . __( 'Card\'s 2-digit expiration month', 'Shopp' ) ); ?></div>
					</span>
					<span>
						<label for="billing-cardexpires-yy"><?php _e( 'YY', 'Shopp' ); ?></label>
						<div class="select-wrap"><?php shopp( 'checkout.billing-cardexpires-yy', 'required=true&minlength=2&maxlength=2&title=' . __( 'Card\'s 2-digit expiration year', 'Shopp' ) ); ?></div>
					</span>
					<span>
						<label for="billing-cardtype"><?php _e( 'Card Type', 'Shopp' ); ?></label>
						<div class="select-wrap"><?php shopp( 'checkout.billing-cardtype', 'required=true&title=' . __( 'Card Type', 'Shopp' ) ); ?></div>
					</span>
				</li>
